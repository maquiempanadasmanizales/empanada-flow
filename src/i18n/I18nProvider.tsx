...
const translations = {
  en: {
    ...
    'home.cumulativeToday': 'Cumulative Today',
    'home.noProductionToday': 'No production yet today',
    'home.productionBars': 'Production Pulse',
    'home.rangeSecond': 'Second',
    'home.rangeMinute': 'Minute',
    'home.rangeHour': 'Hour',
    'home.axisSeconds': 'Seconds',
    'home.axisMinutes': 'Minutes',
    'home.axisHours': 'Hours',
    'home.axisEmpanadas': 'Empanadas',
    ...
    'production.earningsToday': 'Earnings Today',
    'production.profitPerEmpanada': 'Profit per empanada: {value}',
    'production.manualEntry': 'Manual Entry',
    'production.pulseTitle': 'Production Pulse',
    'production.rangeDay': 'Day',
    'production.rangeWeek': 'Week',
    'production.rangeMonth': 'Month',
    'production.noDataRange': 'No production in this range',
  ...
  es: {
    ...
    'home.earningsToday': 'Ganancia de hoy',
    'home.cumulativeToday': 'Acumulado de hoy',
    'home.noProductionToday': 'Sin produccion hoy',
    'home.productionBars': 'Pulso de produccion',
    'home.rangeSecond': 'Segundo',
    'home.rangeMinute': 'Minuto',
    'home.rangeHour': 'Hora',
    'home.axisSeconds': 'Segundos',
    'home.axisMinutes': 'Minutos',
    'home.axisHours': 'Horas',
    'home.axisEmpanadas': 'Empanadas',
    ...
    'production.earningsToday': 'Ganancia de hoy',
    'production.profitPerEmpanada': 'Ganancia por empanada: {value}',
    'production.manualEntry': 'Ingreso manual',
    'production.pulseTitle': 'Pulso de produccion',
    'production.rangeDay': 'Dia',
    'production.rangeWeek': 'Semana',
    'production.rangeMonth': 'Mes',
    'production.noDataRange': 'Sin produccion en este periodo',
